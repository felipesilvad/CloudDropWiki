...
function SkillTreeNew({lv,index,last, skillRec, setActiveSkill, activeSkill}) {
        ...
        <div className='mobile-border'>
          <div className='d-flex skilltree-div w-100'>
            ...
            <div className='skilltree-skill'>
              ...
              skillRec={[skillRec, lv.rec,"1"]} setActiveSkill={setActiveSkill} />
            </div>

            <div className='tree-rank_new d-none d-md-block'>
            ...
            <div className='skilltree-skill'>
              ...
              skillRec={[skillRec, lv.rec,"2"]} setActiveSkill={setActiveSkill} />
            </div>
